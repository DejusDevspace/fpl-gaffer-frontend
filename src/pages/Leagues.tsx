          ...
          <div className="card">
            ...
            <div className="flex items-center justify-between mt-6 pt-4 border-t border-aux">
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-lg bg-surface border border-aux text-primary hover:bg-surface/70 disabled:opacity-50 disabled:cursor-not-allowed transition"
              >
                <ChevronLeft size={18} />
                Previous
              </button>
